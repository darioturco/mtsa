...
public class Compostate<State, Action> {
    ...
    public int forcedToLeavePropagatingLoop = -1;
    public int inPropagateGoalAncestors = -1;
    public int forcedToLeaveInFindNewGoals = -1;
    public int inLoop = -1;
    public int inExploredUncontrollableClausure = -1;
    ...
    HashSet<LinkedList<Integer>> arrivingPaths;
