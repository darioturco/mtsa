...
public class DCSForPython {
    ...
    public void startSynthesis(String path) {
        String[] s = path.split("-");
        int n = Integer.parseInt(s[s.length - 2]);
        int k = Integer.parseInt(s[s.length -1].split("\\.")[0]);
    ...
    public static void main(String[] args) throws OrtException {
        //String FSP_path = "/home/marco/Desktop/Learning-Synthesis/fsp/TL/TL-2-2.fsp";
        String FSP_path = "./DP-2-2.fsp";
