...
//								      memo, ref, heur,proj,modulesCount);
	...
	public static void main(String[] args) {
		...
		Option expansion_budget = cmdParser.addIntegerOption('e',"expbud");
		try {
		...
		if (guiValue != null && guiValue) {
			...
			if(expansionBudgetValue != null) {
				DirectedControllerSynthesisNonBlocking.expansion_budget = expansionBudgetValue;
