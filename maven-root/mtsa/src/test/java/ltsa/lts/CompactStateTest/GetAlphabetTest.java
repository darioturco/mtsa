...
public class GetAlphabetTest {
    ...
    @Test
    public void getLTSAlphabetHideAndCompose() throws Exception {
        String[] solution = new String[]{"c3", "a", "-1", "w", "g1", "g2", "l", "c1", "c2"};
        assertFileWithAlphabetSolution("lts_alphabet_hiding_compose.lts", solution);
    }
